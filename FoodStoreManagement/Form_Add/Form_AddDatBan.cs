...
namespace FoodStoreManagement.Form_Add
{
    public partial class Form_AddDatBan : Form
    {
        ...
        private void Form_AddDatBan_Load(object sender, EventArgs e)
        {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            DatBan_DAL.Instance.AddRow(int.Parse(textBox1.Text), int.Parse(comboBox3.GetItemText(comboBox3.SelectedItem)), comboBox1.GetItemText(comboBox1.SelectedItem), dateTimePicker_Time.Value.TimeOfDay.ToString(), dateTimePicker_Date.Value.Date.ToString("yyyy-MM-dd"), int.Parse(textBox4.Text));
            this.Close();
        }
